...
## Lore
En manque de liberté? Viens voir nos magnifiques aigles certifiés 100% américains.

## Description
C'est un challenge de _heap exploitation_. Il faut exploiter le _double-free_ permis par le service.

## Solution
Voir le fichier `solve.py`.

## Flag
FLAG-1265bc0d890528b3c91c34552b177a51
